...
impl CustomSlider {
    pub fn new(initial_value: f64) -> CustomSlider {
        CustomSlider {
            value: initial_value,
        }
    }
...
impl Widget for CustomSlider {
    ...
    fn layout(
        ...
        //Background
        ctx.position_child(children[0], (0., 0.));

        //Control
        ctx.position_child(children[1], (10., 0.));

        LayoutResult::Size(bc.constrain((bc.max().0, BOX_HEIGHT as f32)))
    }
